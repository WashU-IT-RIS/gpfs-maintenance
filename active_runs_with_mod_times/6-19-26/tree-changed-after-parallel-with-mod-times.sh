...
#SBATCH --array=0-9             # Set this to 0-(N-1) where N is number of directories in your text file
...
# CONFIGURATION
# ==============================================================================
CUTOFF_DATE="2026-06-19 12:00:00"
...
while IFS= read -r -d '' path; do
    ...
    if (( modified || created )); then
        ...
        printf '%-12s %-20s %-50s %s\n' "$type" "$reason" "modified: $modified_time" "$path"
    fi
